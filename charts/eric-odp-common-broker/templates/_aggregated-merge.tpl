...
*/ -}}
{{- define "eric-odp-common-broker.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-odp-common-broker.mergeAnnotations" -}}
  {{- include "eric-odp-common-broker.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-odp-common-broker.mergeLabels" -}}
  {{- include "eric-odp-common-broker.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
